...
<head>
    ...
    <title>Đăng nhập - ShopVnb Store</title>
...
<body>
    ...
    <div class="auth-wrapper">
        <div class="auth-container">
            <h2 class="auth-title">Đăng Nhập Khách Hàng</h2>
            ...
            <form action="<c:url value='/client/login'/>" method="POST" class="auth-form">
            ...
            <div class="auth-links">
                <a href="<c:url value='/client/forgot-password'/>">Quên mật khẩu?</a> | 
                <a href="<c:url value='/client/register'/>">Đăng ký ngay</a>
            </div>
        </div>
    </div>
