...
<div class="page-account">
    <div class="form-account">
        ...
        <form class="inner-form" id="register-form" method="post" action="<c:url value='/admin/register'/>">
            <div class="inner-group">
                <label class="inner-label" for="fullName">Họ tên</label>
                <input class="inner-control" type="text" name="fullName" id="fullName"
                       placeholder="Ví dụ: Lê Văn A" required/>
            </div>
            <div class="inner-group">
            ...
            <div class="inner-meta">
                <div class="inner-confirm">
                    ...
                    <label class="inner-label" for="agree">Tôi chấp nhận các điều khoản và điều kiện</label>
                </div>
            </div>
            <button class="inner-button" type="submit">Đăng Ký</button>
        </form>

        <div class="inner-more"><span>Bạn đã có tài khoản?</span><a href="<c:url value='/admin/login'/>">Đăng nhập</a></div>
    </div>
</div>
