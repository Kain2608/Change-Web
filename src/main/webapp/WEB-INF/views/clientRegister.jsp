...
<head>
    ...
    <title>Đăng ký - ShopVnb Store</title>
    ...
    <style>
        ...
        .auth-container { background: #fff; padding: 40px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); width: 100%; max-width: 500px; }
...
<body>
    ...
    <div class="auth-wrapper">
        <div class="auth-container">
            <h2 class="auth-title">Đăng Ký Tài Khoản Khách Hàng</h2>
            ...
            <form action="<c:url value='/client/register'/>" method="POST" class="auth-form">
            ...
            <div class="auth-links">
                <p>Đã có tài khoản? <a href="<c:url value='/client/login'/>">Đăng nhập</a></p>
            </div>
        </div>
    </div>
