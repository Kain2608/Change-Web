        ...
        <body>
            ...
            <header class="header">
                ...
                <div class="inner-wrap">
                    <div class="inner-notify"><img src="<c:url value='/images/icon-bell.svg'/>" alt=""><span>6</span>
                    </div>
            ...
            <nav class="sider">
                <ul class="inner-menu">
                    ...
                    <li><a href="/admin/category/list"><i class="fa-solid fa-table-cells-large"></i> Quan ly danh
                            mục</a></li>
                    <li><a class="active" href="/admin/product/list"><i class="fa-solid fa-table-list"></i> Quan ly sản
                            phẩm</a></li>
            ...
            <main class="main">
                <h1 class="box-title">Chỉnh sửa vợt cầu lông</h1>

                <div class="section-8">
                    <form method="post" action="<c:url value='/admin/product/edit/racket/${racketDetail.id}'/>">

                    <div class="inner-group">
                        <label class="inner-label" for="name">Tên vợt</label>
                        <input type="text" name="name" value="${racketDetail.name}">
                    </div>
                    <div class="inner-group">
                    ...
                    <div class="inner-group">
                        ...
                        <select name="status">
                            <option value="active" ${racketDetail.status=='active' ? 'selected' : '' }>Hoạt động
                            </option>
                            <option value="inactive" ${racketDetail.status=='inactive' ? 'selected' : '' }>Dừng</option>
                        </select>
                    </div>
                    <div class="inner-group">
                    ...
                    <div class="inner-group">
                        ...
                        <input type="text" name="weight" value="${racketDetail.weight}">
                    </div>

                    <div class="inner-group">
                        <label class="inner-label" for="price">Giá</label>
                        <input type="number" name="price" value="${racketDetail.price}">
                    </div>
                    <div class="inner-group">
                    ...
                    <div class="inner-group inner-two-col">
                        ...
                        <div class="inner-upload-image">
                            <img src="${racketDetail.avatar}" style="width:100px; display:block; margin-bottom:10px;">
                    ...
                    <div class="inner-group inner-two-col">
                        ...
                        <textarea id = "description" name="description">${racketDetail.description}</textarea>
                    </div>
